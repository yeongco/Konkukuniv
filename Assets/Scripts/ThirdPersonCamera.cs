...
public class ThirdPersonCamera : MonoBehaviour
{
    ...
    public Transform parentTransform1;   //the transform of the player or object you want the camera to focus on
    public Transform parentTransform2;   //the transform of the player or object you want the camera to focus on
    public Transform parentTransform3;   //the transform of the player or object you want the camera to focus on
    public Transform parentTransform4;   //the transform of the player or object you want the camera to focus on
    ...
    void Start()
    {
        ...
        tooHigh = false;
        tooLow = false;
        parentTransform = parentTransform1;
    }
    ...
    void Update()
    {
        if(Input.GetKeyDown(KeyCode.Alpha1))
            ...
            parentTransform = parentTransform2;
        else if(Input.GetKeyDown(KeyCode.Alpha3))
            parentTransform = parentTransform3;
        else if (Input.GetKeyDown(KeyCode.Alpha4))
            parentTransform = parentTransform4;
